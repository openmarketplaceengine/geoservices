...
type ReverseGeocoder interface {
	ReverseGeocode(ctx context.Context, location geoservices.LatLng) (*ReverseGeocodeOutput, error)
}
...
func BatchReverseGeocode(
	...
	locations []geoservices.LatLng,
	parallelizationFactor int,
) ([]*ReverseGeocodeOutput, error) {
	g, ctx := errgroup.WithContext(ctx)

	locationsChan := make(chan geoservices.LatLng)
